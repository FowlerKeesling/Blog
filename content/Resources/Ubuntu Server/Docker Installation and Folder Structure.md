...
>
> **\$(. /etc/os-release && echo "\${UBUNTU\_CODENAME:-\$VERSION\_CODENAME}"):** Automatically detects the Ubuntu version codename (such as `jammy` or `noble`) so the correct Docker repository is selected.
>
