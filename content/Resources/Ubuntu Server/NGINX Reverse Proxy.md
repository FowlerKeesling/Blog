...
modified: 2026-09-02T17:49:40.937Z
---
...
7. Copy the API Token and save it in a password manager.
...
2. Log in using the default credentials outline in the NGINX docker compose YAML.
...
5. Save the login credentials to a password manager.
